        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <img src="http://placehold.it/200x200" id="showgambar" style="width:200px;"/>
                </div>

                <div class="form-group">
                    <label for="">Color</label>
                    {!! Form::select('color[]', $colors,null,['class'=>'category form-control select2-multi','multiple'=>'multiple']) !!}
                </div>
                <div class="form-group">
                    <label for="">Tag</label>
                    {!! Form::select('tag[]', $tags,null,['class'=>'category form-control select2-multi','multiple'=>'multiple']) !!}
                </div>
